...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This web is made <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">deGoolan</a>
